...
function drawGrid() {
  ...
  gridMatrix.forEach(function (rowCells, rowIndex) {
    ...
    rowCells.forEach(function (cellContent, cellIndex) {
      ...
      if (riverRows.includes(rowIndex)) cell.classList.add('river');
...
function endGame(reason) {
  ...
  //Blocchiamo il conto alla rovescia
...
// Funzione che muove una riga all'indietro
